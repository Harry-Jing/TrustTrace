...
export const DEV_SCENARIOS = [
  ...
  },
  {
    ...
    label: "Error · rate limited",
    description: "Fails immediately with RATE_LIMITED.",
    stepDelayMs: 0,
    steps: [],
    outcome: {
      type: "failed",
      error: {
        ...
        message: "Hit the provider's rate limit. Try again in a few seconds.",
        retryable: true,
        traceIdSeed: "rate",
      },
    },
  ...
  {
    id: "error.validation",
    label: "Error · input validation",
    description: "Fails immediately with INVALID_INPUT (non-retryable).",
    stepDelayMs: 0,
    steps: [],
    outcome: {
      type: "failed",
      error: {
        code: "INVALID_INPUT",
        category: "validation",
        message: "The input could not be parsed into a checkable claim.",
        retryable: false,
        traceIdSeed: "validation",
      },
    },
  },
